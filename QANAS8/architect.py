...
class Architect(object):
    ...
    def step(self, input_train, target_train, input_valid, target_valid, num_bits_list, bit_schedule, loss_scale, temp=1):
        ...
        if self._args.efficiency_metric == 'flops':
            ...
            loss, loss_energy = self._backward_step_energy(input_valid, target_valid, num_bits_list, bit_schedule, loss_scale, temp=temp)
    ...
    def _backward_step_energy(self, input_valid, target_valid, num_bits_list, bit_schedule, loss_scale, temp=1):
        ...
        if self.energy_weight > 0:
            energy = self.model.module.forward_energy((3, 32, 32), temp=temp)
            ...
            loss_energy = 0
            self.energy_supernet = 0

        self.optimizer.step()
        self.optimizer.zero_grad()

        # print(flops, loss_energy, loss)
        return loss_value, loss_energy
